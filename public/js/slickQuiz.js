...
(function($){
    $.slickQuiz = function(element, options) {
        var plugin   = this,
            ...
            defaults = {
                checkAnswerText:  'Перевірити мою відповідь!',
                nextQuestionText: 'Наступне &raquo;',
                backButtonText: '',
                completeQuizText: '',
                tryAgainText: '',
                questionCountText: 'Питання %current з %total',
                preventUnansweredText: 'Оберіть хоча б одну відповідь.',
        ...
        plugin.method = {
            ...
            completeQuiz: function(options) {
                ...
                //if isset( do everytyhhing that
                var finalMark = levelText.split(" ").pop(); // getting mark and save it to the database
                console.log(window.location.pathname);

                var examId=window.location.pathname.split("/").pop();
                console.log(examId);
                var location= window.location.protocol+'//'+window.location.host+'/exam/'+examId+'/mark/'+finalMark;
                ...
                //
                //xhttp.open("POST", finalMark, true);
                //xhttp.send();
