...
class ExamController extends \BaseController
{
    ...
    public function index($examId)
    {
        ...
        if ($marks) {
            Flash::error('Ви вже пройшли цей тест');
    ...
    public function getQuiz($examId)
    {
        ...
        $data = array(
            "info" => array(
                "name" => $exam->exam_name,
                "main" => "Почнімо!",
                "results" => "Гарна спроба",
                "level1" => "Відмінно 5",
                "level2" => "Добре 4",
                "level3" => "Задовільно 3",
                "level4" => "Незадовільно 2",
                "level5" => "Незадовільно 1"
            ),
    ...
    public function store()
    {
        ...
        Flash::success('Тест успішно створений!');
        return Redirect::to('/');
    ...
    public function update($examId)
    {
        ...
        Flash::success('Тест успішно оновлено!');
        return Redirect::to('/');
